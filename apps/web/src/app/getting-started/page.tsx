            ...
            <Tabs defaultValue="mac" className="w-full">
              ...
              <TabsContent value="mac" className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="p-4 border rounded-lg space-y-3">
                    <h4 className="font-medium">3. Install Git</h4>
                    <div className="relative group">
                      ...
                      <Button
                        ...
                        size="sm"
                        className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity"
                        onClick={() => copyToClipboard("brew install git", 101)}
                      >
                        {copiedIndex === 101 ? (
                          <CheckCircle2 className="h-4 w-4 text-green-600" />
                        ) : (
                  ...
                  <div className="p-4 border rounded-lg space-y-3">
                    <h4 className="font-medium">4. Install Node.js</h4>
                    <div className="relative group">
                      <pre className="bg-muted p-3 rounded-lg">
                  ...
                  <div className="p-4 border rounded-lg space-y-3">
                    <h4 className="font-medium">5. Install pnpm</h4>
                    <div className="relative group">
                      <pre className="bg-muted p-3 rounded-lg">
              ...
              <TabsContent value="windows" className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="p-4 border rounded-lg space-y-3">
                    <h4 className="font-medium">2. Install Git for Windows</h4>
                    <p className="text-sm text-muted-foreground">
                      Download from{" "}
                      <a
                  ...
                  <div className="p-4 border rounded-lg space-y-3">
                    <h4 className="font-medium">3. Install Node.js</h4>
                    <p className="text-sm text-muted-foreground">
                  ...
                  <div className="p-4 border rounded-lg space-y-3">
                    <h4 className="font-medium">4. Install pnpm</h4>
                    <p className="text-sm text-muted-foreground mb-2">
...
└── turbo.json           # Turborepo config`}
                ...
                <Alert>
                  <AlertDescription>
                    This is a monorepo using Turborepo and pnpm workspaces. Each
                    app in the{" "}
                    <code className="text-xs bg-muted px-1 py-0.5 rounded">
                      apps/
                    </code>{" "}
                    directory is a separate package.
                  </AlertDescription>
                </Alert>
              </TabsContent>
              <TabsContent value="commands" className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="bg-muted p-3 rounded-lg">
                    <code className="text-sm font-mono">pnpm build</code>
                    <p className="text-sm text-muted-foreground mt-1">
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            understand the codebase faster. Try asking it to explain components
            or help you make modifications!
          </AlertDescription>
        </Alert>
      </div>
    </div>
